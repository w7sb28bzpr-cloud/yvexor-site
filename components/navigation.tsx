...
export function SiteHeader({root=false}:{root?:boolean}) {
  ...
  const links=[["Solutions","#solutions"],["Matériel","/materiel/"],["YVEXOR Caisses","/caisse/"],["Budgets","#budgets"],["Exemples","#exemples"],["YVEXOR","#yvexor"]];
