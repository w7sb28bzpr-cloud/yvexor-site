...
MEDIA_ROOT = Path(os.environ.get('PORTAL_PRIVATE_FILES', str(BASE_DIR / 'private' / 'uploads'))) if DEBUG else Path('/var/lib/yvexor/files')
MEDIA_URL = '/private-files-not-public/'
EMAIL_TIMEOUT = 10
PASSWORD_RESET_TIMEOUT = 3600
PUBLIC_CLIENT_ORIGIN = os.environ.get('PORTAL_CLIENT_ORIGIN', 'http://127.0.0.1:8181' if DEBUG else 'https://client.yvexor.com')
