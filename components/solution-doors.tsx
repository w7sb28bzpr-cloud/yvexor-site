...
const solutions = [
  ...
  { title: "Notre approche", description: "Au-delà du logiciel : découvrez notre vision pour connecter applications, équipements et monde physique.", icon: "network", image: "approach", href: "/histoire/" },
] as const;
